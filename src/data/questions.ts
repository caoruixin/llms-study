...
④ 加分项：给敏感性——命中率从 60% 到 95% 的成本差；与客户沟通时框架和量级感比精确数字重要。`,
  },
  {
    id: 'te-4',
    category: 'token-econ',
...
① 逐个报数：至少 5 款（GPT/Claude/Gemini/DeepSeek/Kimi/GLM/Qwen 任五），每个模型一句话「定位 + 价格量级 + 上下文」——数字以应用内「模型 API 横评表」为准，与客户沟通前背熟；国产开源价格通常比国际旗舰低一个量级，是成本敏感场景的核心选项。
